    ...
    return (
      ...
      <div className="lobby-create__body">
          ...
          {this.state.activeGroup === "id-card" && (
            <>
              ...
              <div className="lobby-create__input-block">
                ...
                >
                  Пол:{" "}
                  <span>{this.state.sex === "male" ? "Мужской" : "Женский"}</span>
                </Switcher>
              </div>
            </>
          )}
            ...
            <>
              <div className="lobby-create__input-block">
                ...
                >
                  Отец:{" "}
                  <span>
                    {this.state.fathers.values[this.state.fathers.current].name}
                  </span>
                </Switcher>
              </div>
              ...
              <div className="lobby-create__input-block">
                ...
                >
                  Мать:{" "}
                  <span>
                    {this.state.mothers.values[this.state.mothers.current].name}
                  </span>
                </Switcher>
              </div>
        ...
        <div className="lobby-create__body-buttons">
          <Button data-wide onClick={this.onClickCreate}>
            Создать
          </Button>

          <Button data-wide onClick={this.onClickCancel}>
            Отмена
          </Button>
        </div>
      </div>
